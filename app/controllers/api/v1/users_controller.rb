class Api::v1::UsersController < ApplicationController
    ...
    def create
        ...
        render json: {error: "There was a problem saving your user."}, status: :unprocessable_entry and return unless @user
        render json: @user.profile, status: :ok
    end

    def logout
        render json: {error: "There was a problem logging you out."}, status: :unprocessable_entry and return unless UsersService.logout(current_user)
